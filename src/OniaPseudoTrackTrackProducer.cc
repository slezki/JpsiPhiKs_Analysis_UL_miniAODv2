#include "JpsiKKK/JpsiPhiKs/interface/OniaPseudoTrackTrackProducer.h"
...
const RefCountedKinematicParticle OniaPseudoTrackTrackProducer::FitKshort(const reco::Track &tk0, const reco::Track &tk1, edm::ESHandle<TransientTrackBuilder> &theB) {
